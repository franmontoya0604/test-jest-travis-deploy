...
const Products = () => {
    const {state,addToCart} = useContext(AppContext);//traemos la funcion para gregar  al carrito y el estado que vamos a utilizar. cada ves que se use estos se actualiza.
   const {products} = state;//aca sacamos del state
...
addToCart(product)//usamos la funcion del context que mdifica el state.
    ...
    return (
        <div className="Products container">
            ...
            {products.map(product=>(//hacemos mapeo de un componente
